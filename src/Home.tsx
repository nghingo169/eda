...
interface HomeProps {
  onSelect: (view: 'spotify' | 'hatespeech') => void;
}
    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-emerald-500/30 overflow-x-hidden">
      ...
      <header className="relative pt-32 pb-20 px-6 flex flex-col items-center justify-center text-center">
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="p-10 rounded-4xl border border-white/5 bg-zinc-900/30 backdrop-blur-xl">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                {/* Member 1 */}
                <div className="p-6 rounded-2xl bg-zinc-900/50 border border-white/5 text-left">
                  ...
                  <span className="inline-block px-2 py-1 text-[10px] bg-emerald-500/10 text-emerald-400 rounded-full border border-emerald-500/20">
                    Leader
                  </span>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <motion.div
            whileHover={{ y: -8 }}
            className="group relative p-10 rounded-4xl border border-white/5 bg-zinc-900/30 backdrop-blur-2xl transition-all hover:border-red-500/30 text-left overflow-hidden cursor-pointer"
            onClick={() => onSelect('hatespeech')}
          >
            <div className="absolute top-0 right-0 p-8 opacity-[0.03] group-hover:opacity-[0.07] transition-opacity">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-8">
                <div className="w-14 h-14 rounded-2xl bg-red-500/10 flex items-center justify-center text-red-400 group-hover:bg-red-500 group-hover:text-black transition-all duration-500">
                  <ShieldCheck size={28} />
                </div>
